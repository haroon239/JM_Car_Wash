export type Customer = { id:number; name:string; phone:string; plate:string; plan:string; amount:number; due:string; planStartDate:string; status:"Paid"|"Pending"|"Overdue"; archivedAt?:string|null };
...
export type Invoice = { id:number; invoiceNumber:string; customerId:number; customerName:string; plateNumber:string; planName:string; total:number; status:string; issueDate:string; dueDate:string; sentAt?:string|null };
